...
@Component({
  ...
  styles: [`
    ...
    .model-tile { background: var(--bg-placeholder); border: 1px solid var(--border-card); border-radius: 12px; padding: 14px; display: flex; flex-direction: column; gap: 12px; }
    .model-tile__head { display: flex; align-items: center; gap: 10px; }
    .model-tile__icon { width: 28px; height: 28px; border-radius: 7px; display: flex; align-items: center; justify-content: center; background: rgba(218, 165, 32, 0.15); color: var(--color-eyebrow); font-size: 12px; flex-shrink: 0; }
    .model-tile__name { display: block; font-size: 13px; font-weight: 700; color: var(--color-card-value); }
    .model-tile__type { display: block; font-size: 10.5px; color: var(--color-card-sub); }
    ...
    .stat-lbl { font-size: 10px; color: var(--color-card-sub); }
    .stat-val { font-size: 13px; font-weight: 700; color: var(--color-card-value); }
    .model-tile__updated { font-size: 10.5px; color: var(--color-card-sub); }
