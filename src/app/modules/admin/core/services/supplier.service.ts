...
export class SupplierService {
  ...
  getSuppliers(params?: SupplierFilterParams): Observable<ApiResponse<PaginatedResponse<Supplier>>> {
  ...
  getPerformance(): Observable<ApiResponse<PaginatedResponse<SupplierPerformanceItem>>> {
    return this._HttpClient.get<ApiResponse<PaginatedResponse<SupplierPerformanceItem>>>(
